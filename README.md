# Dream Shaper — AI 음성 생성·변조 서비스

> **메타버스 아카데미 2기 프로젝트** (2023.09) · 발주처 한국전파진흥협회 · 6인 팀
> 담당: **AI 서버** (FastAPI · AWS S3 · DALL·E 2) + **음성 모델 학습**

사용자의 음성을 학습해 **원하는 목소리로 노래를 부르게 하거나 목소리를 변조**하는 서비스입니다.
DALL·E 2로 앨범 커버까지 자동 생성해, 음원과 커버를 한 번에 얻을 수 있습니다.
...
> **모델 가중치와 학습 데이터는 올리지 않았습니다.** 코드는 **본인이 작성한 것만** 담았고, diff-svc 본체는 [원본 저장소](https://github.com/prophesier/diff-svc)를 참조하십시오.
